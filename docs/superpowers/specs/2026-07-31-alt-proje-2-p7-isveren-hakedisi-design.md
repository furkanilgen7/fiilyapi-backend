...
| 409 | `OPEN_PAYMENT_EXISTS` · `INVALID_STATUS_TRANSITION` · `PAYMENT_NOT_DELETABLE` |
| 422 | `PERIOD_REQUIRED` · `LINES_REQUIRED` · `CONTRACT_AMOUNT_REQUIRED` · `ITEM_NOT_DISTRIBUTED` · `QUANTITY_EXCEEDS_QUOTA` · `SITE_PROJECT_MISMATCH` · `NO_EMPLOYER_CONTRACT` · Pydantic doğrulamaları |
